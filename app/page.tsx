...
export const metadata: Metadata = {
  title: "ClinicOS — The waiting room, without the waiting",
  description:
    "ClinicOS puts your walk-in queue on every patient's phone — no app, no account, just a name and a number. Honest wait times, calmer front desks, and the flow data your practice has never had.",
};
    ...
    <>
      ...
      <main>
        <Hero
          ...
          sub="ClinicOS lets walk-in patients join your queue from their own phone — no app, no account, just a name and a number — and watch their place in line from wherever they'd rather be. Your front desk gets its day back."
          image="/marketing/hero-home.webp"
          imageAlt="A relaxed patient checking her phone in a bright, modern clinic reception"
          queueMock={{ clinic: "ClinicOS Demo Clinic", position: 3, wait: "~15–20 min" }}
          chip={{ icon: Users, title: "Queue live", sub: "14 waiting · moving now" }}
          mailSubject="ClinicOS demo request"
        />
              ...
              {segments.map((segment) => (
                ...
                >
                  ...
                  <span className="mt-auto flex items-center gap-1.5 pt-6 text-sm font-semibold text-primary">
                    Explore ClinicOS for {segment.name}
                    <ArrowRight
                      size={16}
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-text-secondary">
                    If your clinic runs ClinicOS, find it here and join the queue from
