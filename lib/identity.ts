// ============================================================
// Patient identity validation — shared with the ClinicOS admin portal
// (kept as a verbatim copy; the two apps don't share a package yet, so
// changes here must be mirrored in ClinicOS_AdminPortal/lib/identity.ts).
//
