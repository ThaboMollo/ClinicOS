...
export const segments: SegmentContent[] = [
  {
    ...
    metaDescription:
      "ClinicOS for dental practices: give anxious patients a live, honest view of their wait, capture pain-score intake before they sit down, and collect five-star feedback at the moment of relief.",
    eyebrow: "ClinicOS for dental practices",
    heroTitle: "An empty waiting room is the sign of a well-run practice.",
    heroSub:
      "Dentistry runs on precision scheduling — and gets ambushed by emergencies, overruns and walk-ins. ClinicOS gives every patient a live, honest view of their wait on their own phone, so the 2 pm crown that runs long doesn't wreck the 3 pm mood.",
    ...
    mailSubject: "ClinicOS demo — dental practice",
    ...
    featureTitle: "What changes with ClinicOS",
    featureIntro:
    ...
    faqs: [
      {
        ...
        a: "Yes. ClinicOS handles the part your appointment book can't: emergencies, walk-ins, and the knock-on delays when treatments overrun. Patients who arrive early or get bumped see a live, honest wait instead of silence at the desk — and your booked schedule stays exactly where it is.",
      },
      {
  ...
  },
  {
    ...
    metaTitle: "For GPs",
    metaDescription:
      "ClinicOS for general practice: put the walk-in queue on every patient's phone, with honest wait times learned from your real pace. Empty the room, keep the list true, start every consult prepared.",
    eyebrow: "ClinicOS for general practice",
    heroTitle: "Monday, 07:58. Fourteen patients at the door. Calm.",
    heroSub:
      "General practice lives and dies by the walk-in queue. ClinicOS puts that queue on every patient's phone — with wait times learned from how fast you're actually consulting today — so the room empties, the desk quietens, and nobody loses their place.",
    ...
    mailSubject: "ClinicOS demo — GP practice",
  ...
  },
  {
    ...
    metaDescription:
      "ClinicOS for clinics and health centres: live queues for patients, and the operational record you've never had — arrivals by hour, real waits, abandonment — per clinic, per day.",
    eyebrow: "ClinicOS for clinics & health centres",
    heroTitle: "You can't fix a queue you can't see.",
    heroSub:
      "High-volume clinics run on flow — and flow has always been invisible. ClinicOS shows patients their place in line, and shows you the whole day: arrivals by hour, real waits, walk-aways. Your operations, finally on the record.",
    ...
    mailSubject: "ClinicOS demo — clinic / health centre",
    ...
    faqs: [
      {
        ...
        a: "No — it sits at the front door. ClinicOS runs the walk-in queue and its analytics; your clinical, billing and record systems stay exactly as they are. Scheduled-appointment check-in is on the roadmap.",
      },
      {
