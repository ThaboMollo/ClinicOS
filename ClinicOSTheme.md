# ClinicOS Theme & UI Instructions (MVP v1)
> Purpose: Keep ClinicOS looking **clean, clinical, modern, and trustworthy** across Admin Portal + Patient Mobile Web.
...
### Placement rules
- Admin Portal:
  - Top-left in navbar (icon + “ClinicOS” text)
- Patient App:
