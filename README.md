...
Styling follows the design system in `ClinicOSTheme.md`: Inter font, primary blue `#0B5AA8`, accent teal `#20C997`, 44px minimum tap targets, and a 560px content column that becomes a centered card on desktop. The full MVP scope and UX flow are documented in `PatientMobileWebBuildPlan.md`.
